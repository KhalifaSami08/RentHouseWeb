...
export const getPropertyByIdAPI = async (idProperty) => {
  let property;
  await axios
    .get("http://localhost:5000/api/property/" + idProperty)
...
export const addPropertyAPI = async (property) => {
  await axios
    .post("http://localhost:5000/api/property/", property)
...
export const updatePropertyAPI = async (property) => {
  await axios
    .put("http://localhost:5000/api/property/" + property.idProperty, property)
    .then((res) => console.log(res))
    .catch((err) => console.log(err));
};
...
export const deletePropertyAPI = async (idprop) => {
  await axios
    .delete("http://localhost:5000/api/property/" + idprop)
    .then((res) => console.log(res))
    .catch((err) => console.log(err));
};
