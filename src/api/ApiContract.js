...
export const getAllContractsAPI = async () => {
  let listOfContracts = [];
  await axios
    .get("http://localhost:5000/api/contract")
...
export const getContractByIdAPI = async (idContract) => {
  let contract;
  await axios
    .get("http://localhost:5000/api/contract/" + idContract)
...
export const addContractAPI = async (contract) => {
  await axios
    .post("http://localhost:5000/api/contract/", contract)
...
export const updateContractAPI = async (contract) => {
  await axios
    .put("http://localhost:5000/api/contract/" + contract.idContract, contract)
    .then((res) => console.log(res))
    .catch((err) => console.log(err));
};
...
export const deleteContractAPI = async (idContract) => {
  axios
    .delete("http://localhost:5000/api/contract/" + idContract)
    .then((res) => {
      console.log(res);
